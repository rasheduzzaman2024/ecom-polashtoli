...
const Auth = {
    ...
    redirectToDashboard: function() {
        ...
        const currentPath = window.location.pathname;
        const isInSubfolder = currentPath.includes('/admin/') || currentPath.includes('/customer/');
        
        switch(user.role) {
            case ROLES.ADMIN:
                window.location.href = isInSubfolder ? 'dashboard.html' : 'admin/dashboard.html';
                break;
            case ROLES.SALESMAN:
                window.location.href = isInSubfolder ? 'dashboard.html' : 'admin/dashboard.html';
                break;
            case ROLES.CUSTOMER:
                window.location.href = isInSubfolder ? 'dashboard.html' : 'customer/dashboard.html';
                break;
            default:
